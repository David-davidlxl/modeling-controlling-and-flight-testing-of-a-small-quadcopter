 ...
 * C/C++ source code generated on : Thu Feb 23 18:50:10 2023
 *
  ...
  P_FlightControlSystem_flightControlSystem_T *localP)
{
  ...
  {
    static real_T pTimeValues0[] = { 0.0, 42.0 } ;
  ...
  {
    static real_T pTimeValues0[] = { 0.0, 20.0, 25.0, 42.0 } ;

    static real32_T pDataValues0[] = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F,
      1.0F, -0.7F, -0.7F, -0.7F, -0.7F } ;
  ...
  /* FromWorkspace: '<S21>/From Workspace' */
  {
    ...
    if (t < pTimeValues[0]) {
    ...
    } else if (t == pTimeValues[1]) {
      {
        int_T elIdx;
        for (elIdx = 0; elIdx < 3; ++elIdx) {
          (&localB->YawPitchRoll[0])[elIdx] = pDataValues[1];
          pDataValues += 2;
        }
      }
    } else if (t > pTimeValues[1]) {
    ...
    if (t >= pTimeValues[3]) {
      {
        int_T elIdx;
        for (elIdx = 0; elIdx < 3; ++elIdx) {
          (&localB->XYZ[0])[elIdx] = pDataValues[3];
          pDataValues += 4;
        }
      }
    } else {
